...
const Home = () => {
  return (
      <>
        <section id="header" className="top-0 left-0 min-h-full w-full overflow-hidden bg-black/90 transition-all duration-300 ease-in-out dark:bg-white/90">
          ...
          <div className="flex h-screen w-screen flex-row items-center justify-between px-40">
            <div className="flex flex-col items-start">
              ...
              <div className="z-10 flex flex-row items-center justify-center gap-4 pt-2">
                ...
                <button
                    className="animate-fade-in-up-delay bg-linear-to-bl from-gray-600 to-gray-800 text-white transition-all duration-200 ease-in-out hover:-translate-y-0.5 hover:cursor-pointer hover:bg-gray-900"
                    onClick={() =>
                        openInNewTab(
        ...
        <section id="footer" className="flex h-24 w-full items-center justify-center bg-black/90 text-white transition-all duration-300 ease-in-out dark:bg-white/90">
